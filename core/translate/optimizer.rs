...
fn use_indexes(
    ...
    let did_eliminate_orderby = false;
            ...
            match index {
                ...
                Some(index) => {
                    let available_indexes = available_indexes
                        ...
                        .cloned()
                        .collect::<Vec<_>>();
                    if let Some(best_index) = try_extract_index_search_from_where_clause(
                        where_clause,
                        table_index,
                        table_reference,
                        &available_indexes,
                        ...
                        table_reference.op = Operation::Search(Search::Seek {
                            index: best_index.index,
                            seek_def: best_index
                                .seek_def
                                .expect("best_index should have a SeekDef"),
                        });
                    }
                }
                None => {
...
pub fn try_extract_index_search_from_where_clause(
    ...
    best_index.seek_def = Some(seek_def);
