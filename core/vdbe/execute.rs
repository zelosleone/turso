...
/// Macro to destructure an Insn, only to be used when it
...
pub fn op_init(
    ...
    assert_insn!(Insn::Init { target_pc } = insn);
...
pub fn op_add(
    ...
    assert_insn!(Insn::Add { lhs, rhs, dest } = insn);
...
pub fn op_subtract(
    ...
    assert_insn!(Insn::Subtract { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_multiply(
    ...
    assert_insn!(Insn::Multiply { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_divide(
    ...
    assert_insn!(Insn::Divide { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_drop_index(
    ...
    assert_insn!(Insn::DropIndex { index, db: _ } = insn);
    program
        .connection
...
pub fn op_remainder(
    ...
    assert_insn!(Insn::Remainder { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_bit_and(
    ...
    assert_insn!(Insn::BitAnd { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_bit_or(
    ...
    assert_insn!(Insn::BitOr { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_bit_not(
    ...
    assert_insn!(Insn::BitNot { reg, dest } = insn);
...
pub fn op_null_row(
    ...
    assert_insn!(Insn::NullRow { cursor_id } = insn);
    {
...
pub fn op_not_null(
    ...
    assert_insn!(Insn::NotNull { reg, target_pc } = insn);
    assert!(target_pc.is_offset());
    let reg = *reg;
    let target_pc = *target_pc;
    match &state.registers[reg].get_owned_value() {
...
pub fn op_vopen(
    ...
    assert_insn!(Insn::VOpen { cursor_id } = insn);
    let (_, cursor_type) = program.cursor_ref.get(*cursor_id).unwrap();
...
pub fn op_vdestroy(
    ...
    assert_insn!(Insn::VDestroy { db, table_name } = insn);
    let conn = program.connection.clone();
    {
...
pub fn op_result_row(
    ...
    assert_insn!(Insn::ResultRow { start_reg, count } = insn);
    let row = Row {
...
pub fn op_goto(
    ...
    assert_insn!(Insn::Goto { target_pc } = insn);
    assert!(target_pc.is_offset());
    state.pc = target_pc.as_offset_int();
    Ok(InsnFunctionStepResult::Step)
}
...
pub fn op_integer(
    ...
    assert_insn!(Insn::Integer { value, dest } = insn);
...
pub fn op_real(
    ...
    assert_insn!(Insn::Real { value, dest } = insn);
...
pub fn op_real_affinity(
    ...
    assert_insn!(Insn::RealAffinity { register } = insn);
...
pub fn op_string8(
    ...
    assert_insn!(Insn::String8 { value, dest } = insn);
...
pub fn op_blob(
    ...
    assert_insn!(Insn::Blob { value, dest } = insn);
...
pub fn op_row_data(
    ...
    assert_insn!(Insn::RowData { cursor_id, dest } = insn);
...
pub fn op_row_id(
    ...
    assert_insn!(Insn::RowId { cursor_id, dest } = insn);
    if let Some((index_cursor_id, table_cursor_id)) = state.deferred_seeks[*cursor_id].take() {
        let deferred_seek = 'd: {
            let rowid = {
                let mut index_cursor = state.get_cursor(index_cursor_id);
...
pub fn op_idx_row_id(
    ...
    assert_insn!(Insn::IdxRowId { cursor_id, dest } = insn);
    let mut cursors = state.cursors.borrow_mut();
...
pub fn op_seek_end(
    ...
    assert_insn!(Insn::SeekEnd { cursor_id } = *insn);
    {
        let mut cursor = state.get_cursor(cursor_id);
        let cursor = cursor.as_btree_mut();
...
pub fn op_decr_jump_zero(
    ...
    assert_insn!(Insn::DecrJumpZero { reg, target_pc } = insn);
    assert!(target_pc.is_offset());
    match state.registers[*reg].get_owned_value() {
        Value::Integer(n) => {
            let n = n - 1;
...
pub fn op_agg_final(
    ...
    assert_insn!(Insn::AggFinal { register, func } = insn);
...
pub fn op_end_coroutine(
    ...
    assert_insn!(Insn::EndCoroutine { yield_reg } = insn);
...
pub fn op_delete(
    ...
    assert_insn!(Insn::Delete { cursor_id } = insn);
    {
        let mut cursor = state.get_cursor(*cursor_id);
        let cursor = cursor.as_btree_mut();
...
pub fn op_must_be_int(
    ...
    assert_insn!(Insn::MustBeInt { reg } = insn);
    match &state.registers[*reg].get_owned_value() {
        Value::Integer(_) => {}
...
pub fn op_soft_null(
    ...
    assert_insn!(Insn::SoftNull { reg } = insn);
...
pub fn op_create_btree(
    ...
    assert_insn!(Insn::CreateBtree { db, root, flags } = insn);
...
pub fn op_drop_table(
    ...
    assert_insn!(Insn::DropTable { db, table_name, .. } = insn);
    if *db > 0 {
        todo!("temp databases not implemented yet");
    }
    let conn = program.connection.clone();
...
pub fn op_close(
    ...
    assert_insn!(Insn::Close { cursor_id } = insn);
    let mut cursors = state.cursors.borrow_mut();
...
pub fn op_is_null(
    ...
    assert_insn!(Insn::IsNull { reg, target_pc } = insn);
...
pub fn op_page_count(
    ...
    assert_insn!(Insn::PageCount { db, dest } = insn);
    if *db > 0 {
        // TODO: implement temp databases
        todo!("temp databases not implemented yet");
    }
...
pub fn op_read_cookie(
    ...
    assert_insn!(Insn::ReadCookie { db, dest, cookie } = insn);
    if *db > 0 {
        // TODO: implement temp databases
        todo!("temp databases not implemented yet");
    }
...
pub fn op_shift_right(
    ...
    assert_insn!(Insn::ShiftRight { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_shift_left(
    ...
    assert_insn!(Insn::ShiftLeft { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_add_imm(
    ...
    assert_insn!(Insn::AddImm { register, value } = insn);
...
pub fn op_variable(
    ...
    assert_insn!(Insn::Variable { index, dest } = insn);
...
pub fn op_zero_or_null(
    ...
    assert_insn!(Insn::ZeroOrNull { rg1, rg2, dest } = insn);
...
pub fn op_not(
    ...
    assert_insn!(Insn::Not { reg, dest } = insn);
    state.registers[*dest] =
...
pub fn op_concat(
    ...
    assert_insn!(Insn::Concat { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_and(
    ...
    assert_insn!(Insn::And { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_or(
    ...
    assert_insn!(Insn::Or { lhs, rhs, dest } = insn);
    state.registers[*dest] = Register::Value(
        state.registers[*lhs]
            .get_owned_value()
...
pub fn op_cast(
    ...
    assert_insn!(Insn::Cast { reg, affinity } = insn);
...
pub fn op_rename_table(
    ...
    assert_insn!(Insn::RenameTable { from, to } = insn);
