    ...
    fn arbitrary_from<R: rand::Rng>(rng: &mut R, t: &SimulatorEnv) -> Self {
        ...
        loop {
            ...
            let expr = match choice {
                ...
                // TODO: Skip Column as this is not generated by Parser Normally
                5 => continue,
                ...
                // TODO: skip InTable
                13 => continue,
                14 => Expr::IsNull(Box::arbitrary_from(rng, t)),
                15 => {
                ...
                16 => Expr::Literal(ast::Literal::arbitrary_from(rng, t)),
                // TODO: skip Name
                17 => continue,
                18 => Expr::NotNull(Box::arbitrary_from(rng, t)),
                // TODO: only support one paranthesized expression
                19 => Expr::Parenthesized(vec![Expr::arbitrary_from(rng, t)]),
                20 => {
                ...
                // TODO: skip Raise
                21 => continue,
                // TODO: skip RowId not emitted by parser
                22 => continue,
                // TODO: skip subquery
                23 => continue,
                24 => Expr::Unary(
                ...
                // TODO: skip Variable as it does not make much sense for the simulator
                25 => continue,
                _ => unreachable!(),
            };
            break expr;
    ...
    fn arbitrary_from<R: rand::Rng>(rng: &mut R, _t: &SimulatorEnv) -> Self {
        loop {
            ...
            let lit = match choice {
                ...
                1 => ast::Literal::String(gen_random_text(rng)),
